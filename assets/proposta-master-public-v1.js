(()=>{
  ...
  async function loadMaster(){
    ...
    const [htmlRes,dataRes]=await Promise.all([
      fetch('/master-template/proposta-master-limpa-v1.html?v=4',{cache:'no-store'}),
    ...
    await new Promise((resolve,reject)=>{const s=document.createElement('script');s.src='/master-template/proposta-master-limpa-v1.js?v=4';s.onload=resolve;s.onerror=()=>reject(new Error('Não foi possível carregar os dados da proposta.'));document.body.appendChild(s)});
