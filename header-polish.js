(function(){
  function ensureStyle(){
    ...
    style.textContent=`
      .top{padding:0!important;min-height:118px!important;display:block!important}
      .top .fenix-top-inner{max-width:1100px;margin:0 auto;padding:10px 22px;min-height:118px;display:flex!important;align-items:center!important;gap:24px!important}
      .top .fenix-top-logo{width:360px!important;max-height:96px!important;object-fit:contain!important;object-position:left center!important;display:block!important;flex:0 0 auto!important}
      ...
      @media(max-width:800px){
        .top{min-height:98px!important}
        .top .fenix-top-inner{min-height:98px;padding:8px 16px;gap:14px!important}
        .top .fenix-top-logo{width:250px!important;max-height:78px!important}
      ...
      @media(max-width:560px){
        ...
        .top .fenix-top-logo{width:280px!important;max-width:100%!important;max-height:82px!important}
